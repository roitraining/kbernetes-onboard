# Navigate to the frontend yaml again and add the following readiness prove at the bottom of the  deployment, immediately above the ---.  It is at the same indent level as resources 
