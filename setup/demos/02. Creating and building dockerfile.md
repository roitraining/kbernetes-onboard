...
# in the editor and create a new file named:
...
# WARNING! if you are doing this in cloud shell, the previous space invaders app will 
# probably be cached on 8080 - force a hard refresh  by holding down the SHIFT key as 
# you click on the refresh icon
...
# examine and delete the 3 images (optional if not in cloud shell).  Add the -f flag 
# at the end if any image won't delete in cloud shell.
